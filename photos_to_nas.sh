#!/bin/bash
REPERTOIRE_SOURCE="/home/martin/Documents/Photos/"
REPERTOIRE_DESTINATION="Sherlock@192.168.1.18:/var/services/homes/Sherlock/Drive/Photos"
SSH="Sherlock@192.168.1.18"
REPERTOIRE_COMPTE_RENDU="/home/martin/Documents/Projets/Scripts/CR_scripts/CR_photos_to_nas/"
...
zenity --question --no-wrap\
    --text="Souhaitez vous lancer le script pour synchroniser votre dossier Photos sur votre Nas ?" 2> /dev/null
