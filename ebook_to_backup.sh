...
REPERTOIRE_DESTINATION="/media/martin/backup/Ebook/"
REPERTOIRE_COMPTE_RENDU="/home/martin/Documents/Projets/Scripts/CR_scripts/CR_ebook_to_backup/"
today="`date +"%d-%m-%Y"`"
...
zenity --question --no-wrap\
    --text="Souhaitez vous lancer le script pour synchroniser votre dossier Ebook sur votre disque de backup ?" 2> /dev/null
